<template>
	<h1>Post</h1>
	<section v-if="mySauce">
		<mySauce :mySauce ="mySauce"/>
	</section>
	...
	<button v-on:click ='addImage'><span>addImage</span><span>
	<svg style="width:24px;height:24px;margin-bottom:5px">
        <path
            fill="rgba(253, 45, 6, 0.5)"
...
<script>
	...
	import mySauce from '../components/mySauce.vue'
	export default{
		components: {
			mySauce
		},
		...
		async created() {
			...
			this.mySauce = response.data
			console.log(this.mySauce)
